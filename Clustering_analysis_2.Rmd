...
kmeans_result <- kmeans(scaled_data, centers = 5, nstart = 20)
...
ggplot(ci_df, aes(x = factor(Cluster), y = (Lower + Upper) / 2)) +
  geom_point(size = 3) +
  geom_errorbar(aes(ymin = Lower, ymax = Upper), width = 0.2) +
  labs(
    title = "CO2 Emissions Confidence Intervals by Cluster",
    x = "Cluster",
    y = "Mean CO2 Emissions (g/km)"
  ) +
  theme_minimal()
```
...
ggplot(ci_df, aes(x = factor(Cluster), y = (Lower + Upper) / 2)) +
  ...
  geom_errorbar(aes(ymin = Lower, ymax = Upper), width = 0.2) +
  labs(
    title = "Engine.Coolant.Temperature..C. Confidence Intervals by Cluster",
    x = "Cluster",
    y = "Mean Engine.Coolant.Temperature..C."
  ) +
  theme_minimal()
```

Now let's us see how the clusters behave in case of **Intake.Air.Temperature..C.**

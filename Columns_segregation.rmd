...
#Trimmable Paremeters:(Which Follows Description):
CO₂ in g/km (Average)
Trip Distance (km)
...
#Non-Trimmable Parameters:(Which Follows Description):
Engine kW (At the wheels)
Horsepower..At.the.wheels..hp.
Trip average Litres/100 Km
Absolute Throttle Position B(%)
Relative Throttle Position (B%)
Accelerator Pedal position both E and D(%)
Throttle.Position.Manifold...
Kilometers Per Litre(Instant)(kpl)
Miles per Gallon(Long Term Average)(mpg)
G(X)
Miles per Gallon
Engine Rpm(Following with inconsisteny)
Intake Air Temperature (same as above)
